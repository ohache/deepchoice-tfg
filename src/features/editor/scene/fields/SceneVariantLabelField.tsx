...
type SceneVariantLabelFieldProps = {
  label?: string;
  value: string;
  active: boolean;
  onToggle: () => void;
...
export function SceneVariantLabelField({ label = "Nombre", value, active, onToggle, inputRef, onChange, onEnterDone,
  placeholder = "Ej: Capa bosque nocturno" }: SceneVariantLabelFieldProps) {
